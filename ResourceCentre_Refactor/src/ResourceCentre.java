...
public class ResourceCentre {
	...
	public static void main(String[] args) {
		...
		while (option != ResourceCentre.OPTION_QUIT) {

			ResourceCentre.menu();
			option = Helper.readInt("Enter an option > ");

			if (option == ResourceCentre.OPTION_VIEW) {
				// View all items
				ResourceCentre.viewAllCamcorder(camcorderList);
				ResourceCentre.viewAllChromebook(chromebookList);

			} else if (option == ResourceCentre.OPTION_ADD) {
				// Add a new item
				...
				if (itemType == ResourceCentre.OPTION_VIEW) {
					// Add a camcorder
					Camcorder cc = inputCamcorder();
					ResourceCentre.addCamcorder(camcorderList, cc);
					System.out.println("Camcorder added");

				} else if (itemType == ResourceCentre.OPTION_ADD) {
					// Add Chromebook
			...
			} else if (option == ResourceCentre.OPTION_LOAN) {
				// Loan item
			...
			} else if (option == ResourceCentre.OPTION_RETURN) {
				// Return item
			...
			} else if (option == ResourceCentre.OPTION_QUIT) {
